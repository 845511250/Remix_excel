package com.example.zuoyun.remix_excel.tools;
...
public class CircularProgress extends View {
    ...
    public ArrayList<String> mAngleOffset;
    public int aass;
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.myred);
        mColors[1] = context.getResources().getColor(R.color.myyellow);
        mColors[2] = context.getResources().getColor(R.color.mygreen);
        mColors[3] = context.getResources().getColor(R.color.myblue);
