...
String sdCardPath = "/storage/emulated/0/Pictures";
    ...
    void drawText(Canvas canvas) {
        canvas.drawRect(3500, 3, 4000, 25, rectPaint);
        canvas.drawText(time + "  浴帘  " + orderItems.get(currentID).order_number + "    " + orderItems.get(currentID).newCode, 3520, 23, paintSmall);
    }

    public void remixx(){
        Bitmap bitmapCombine = Bitmap.createBitmap(7100, 6800 + 60, Bitmap.Config.ARGB_8888);
